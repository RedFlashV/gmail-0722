...
public class AttrAttrgroupRelationController {
    ...
    public  Resp<Object> deleRelation(@RequestBody List<AttrAttrgroupRelationEntity>relationEntityList){
        this.attrAttrgroupRelationService.deleRelation(relationEntityList);
        return Resp.ok("删除成功");
